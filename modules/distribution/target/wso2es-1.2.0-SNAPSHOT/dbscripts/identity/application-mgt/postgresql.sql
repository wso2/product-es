...
CREATE TABLE SP_INBOUND_AUTH (
            ID INTEGER NEXTVAL('SP_INBOUND_AUTH_SEQ'),
	     	TENANT_ID INTEGER NOT NULL,
...
CREATE TABLE SP_AUTH_STEP (
            ID INTEGER NEXTVAL('SP_AUTH_STEP_SEQ'),
            TENANT_ID INTEGER NOT NULL,
...
CREATE TABLE SP_CLAIM_MAPPING (
	    	ID INTEGER NEXTVAL('SP_CLAIM_MAPPING_SEQ'),
	    	TENANT_ID INTEGER NOT NULL,
...
CREATE TABLE SP_ROLE_MAPPING (
	    	ID INTEGER NEXTVAL('SP_ROLE_MAPPING_SEQ'),
	    	TENANT_ID INTEGER NOT NULL,
...
CREATE TABLE SP_REQ_PATH_AUTHENTICATOR (
	    	ID INTEGER NEXTVAL('SP_REQ_PATH_AUTH_SEQ'),
	    	TENANT_ID INTEGER NOT NULL,
...
CREATE TABLE SP_PROVISIONING_CONNECTOR (
	    	ID INTEGER NEXTVAL('SP_PROV_CONNECTOR_SEQ'),
	    	TENANT_ID INTEGER NOT NULL,
...
CREATE TABLE IDP_ROLE (
			ID INTEGER NEXTVAL('IDP_ROLE_SEQ'),
			IDP_ID INTEGER,
			TENANT_ID INTEGER,
			ROLE VARCHAR(254),
			PRIMARY KEY (ID),
...
CREATE TABLE IDP_ROLE_MAPPING (
			ID INTEGER NEXTVAL('IDP_ROLE_MAPPING_SEQ'),
			IDP_ROLE_ID INTEGER,
			TENANT_ID INTEGER,
...
CREATE TABLE IDP_CLAIM (
			ID INTEGER NEXTVAL('IDP_CLAIM_SEQ'),
			IDP_ID INTEGER,
			TENANT_ID INTEGER,
			CLAIM VARCHAR(254),
			PRIMARY KEY (ID),
...
CREATE TABLE IDP_CLAIM_MAPPING (
			ID INTEGER NEXTVAL('IDP_CLAIM_MAPPING_SEQ'),
...
CREATE TABLE IDP_AUTHENTICATOR (
            ID INTEGER NEXTVAL('IDP_AUTHENTICATOR_SEQ'),
            TENANT_ID INTEGER,
            IDP_ID INTEGER,
...
CREATE TABLE IDP_AUTHENTICATOR_PROPERTY (
            ID INTEGER NEXTVAL('IDP_AUTHENTICATOR_PROP_SEQ'),
            TENANT_ID INTEGER,
...
CREATE TABLE IDP_PROVISIONING_CONFIG (
            ID INTEGER NEXTVAL('IDP_PROV_CONFIG_SEQ'),
            TENANT_ID INTEGER,
            IDP_ID INTEGER,
...
CREATE TABLE IDP_PROV_CONFIG_PROPERTY (
            ID INTEGER NEXTVAL('IDP_PROV_CONFIG_PROP_SEQ'),
            TENANT_ID INTEGER,
...
CREATE TABLE IDP_PROVISIONING_ENTITY (
            ID INTEGER NEXTVAL('IDP_PROV_ENTITY_SEQ'),
            PROVISIONING_CONFIG_ID INTEGER,
...
CREATE TABLE IF NOT EXISTS IDP_LOCAL_CLAIM(
            ID INTEGER NEXTVAL('IDP_LOCAL_CLAIM_SEQ'),
            TENANT_ID INTEGER,
            IDP_ID INTEGER,
