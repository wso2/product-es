...
public class CustomLifecyclesChecklistAdminClient {
    ...
    public CustomLifecyclesChecklistAdminClient(String backEndUrl, String sessionCookie) throws AxisFault {
        String endPoint = backEndUrl + serviceName;
        customLifecyclesChecklistAdminServiceStub = new CustomLifecyclesChecklistAdminServiceStub(endPoint);
        org.wso2.es.integration.common.clients.AuthenticateStub.authenticateStub(sessionCookie, customLifecyclesChecklistAdminServiceStub);
    }
}
