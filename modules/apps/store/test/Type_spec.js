...
describe('Types - Store API', function () {
       

        it('Get all types with valid username:password', function () {
            ...
            var url = server_url+'v2/assets/type';
            var data ={};
...
describe('Type with attributes - Store API', function () {
       

        it('Get type of given asset-id with valid username:password', function () {
            var username = conf.authConfiguration.username;
            var password = conf.authConfiguration.password;
            var server_url = conf.StoreConfigurations.url;
