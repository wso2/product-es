...
(function () {
    ...
    typeof process == "undefined" || !process.nextTick ? a.nextTick = function (a) {
        ...
        (function h() {
            ...
            while (g < b && f < a.length)f += 1, g += 1, c(a[f - 1], function (b) {
                b ? (d(b), d = function () {
    ...
    a.concat = h(n), a.concatSeries = i(n), a.whilst = function (b, c, d) {
        ...
        var e = 0, f = {tasks: [], concurrency: c, saturated: null, empty: null, drain: null, push: function (b, e) {
            b.constructor !== Array && (b = [b]), d(b, function (b) {
                f.tasks.push({data: b, callback: typeof e == "function" ? e : null}), f.saturated && f.tasks.length == c && f.saturated(), a.nextTick(f.process)
            })
        }, process: function () {
